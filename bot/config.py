...
def round_up_to_500(amount: float) -> int:
    """يقرّب السعر لأقرب ليرة — مطابق تماماً لطريقة الموقع.

    (كان سابقاً يقرّب لأعلى لأقرب 500 ل.س، وهذا كان يجعل أسعار البوت
     أغلى من الموقع بفارق يصل إلى 499 ل.س. أُلغي التقريب ليتطابق الاثنان.
     الاسم مُبقى كما هو حتى لا تنكسر بقية الاستدعاءات.)
    """
    if amount <= 0:
        return 0
